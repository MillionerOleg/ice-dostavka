			...
			switch ($blockName)
			{
				...
				case 'quantity':
					if (!$haveOffers)
					{
						...
						{
							?>
							<div class="product-item-info-container product-item-hidden d-flex" data-entity="quantity-block">
								<div class="product-item-amount d-flex justify-content-center">
				...
				case 'buttons':
					?>
					<div class="product-item-info-container product-item" data-entity="buttons-block">
						<?
						if (!$haveOffers)
						{
				...
				case 'props':
					if (!$haveOffers)
					{
						...
						{
							?>
							<div class="product-item-info-container product-item" data-entity="props-block">
							...
							<div class="product-item-separator"></div>
							<?
						}
