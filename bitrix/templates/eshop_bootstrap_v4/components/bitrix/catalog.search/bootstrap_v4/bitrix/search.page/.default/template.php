...
<div class="search-page d-flex align-items-center">
		...
		<?else:?>
			<div class="input-group">
				...
				<div class="input-group-append">
					<input id="search-btn" class="fa fa-search" type="submit" value="  " />
					<label id="search-txt" for="search-btn"><i class='fa fa-search'></i></label>
				</div>
			</div>
		<?endif;?>
