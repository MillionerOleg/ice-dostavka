				...
				case 'TILE':
					foreach ($arResult['SECTIONS'] as &$arSection)
					{
						...
						if (false === $arSection['PICTURE'])
							...
							?>
							<li id="<? echo $this->GetEditAreaId($arSection['ID']); ?>"  class="col-lg-3 col-xl-2 col-md-4 col-sm-6 col-12 d-flex catalog-section-list-item">
								...
								{
									?>
										<div class="catalog-section-list-item-inner d-flex align-items-center">
											<h3 class="catalog-section-list-item-title">
												<a class="catalog-section-list-item-link" href="<? echo $arSection['SECTION_PAGE_URL']; ?>">
													<? echo $arSection['NAME']; ?>
												</a>
