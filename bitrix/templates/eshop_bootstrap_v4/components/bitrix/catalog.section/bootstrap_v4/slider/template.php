...
<div class="">
	...
	if (!empty($arResult['RAW_ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		foreach ($arResult['ITEM_ROWS'] as $key => $rowData)
		{
			...
			$rowIds[] = $rowId;
			?>
			<div id="view" class="row main" data-entity="items-row">
				<div id="items" class="slider slider-nav">
					<?
...
<div class="action">
	<input type="range" min="9" max="20"  value="0" step="1">
</div>
...
if (count($arResult['ITEMS']) > 1)
{
	...
	<script src="https://code.jquery.com/jquery-2.2.0.min.js" type="text/javascript"></script>
  	<script src="<?=SITE_TEMPLATE_PATH?>/components/bitrix/catalog.top/bootstrap_v4/slider/slick/slick.js" type="text/javascript" charset="utf-8"></script>
	<script src="<?=SITE_TEMPLATE_PATH?>/components/bitrix/catalog.top/bootstrap_v4/slider/custom-slider.js"></script>
	<?
}
?>