...
<div class="row<?=$themeClass?>"> <? // wrapper ?>
	<div id="slider-box" class="col p-0">
	<?
	//region Pagination
	if ($showTopPager)
	{
	...
	//endregion
	?>
		<div id="slider-one" class="mb-4 catalog-section slider slider-nav" data-entity="<?=$containerName?>">
		...
		<!-- items-container -->
					...
					if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
					{
						...
						foreach ($arResult['ITEM_ROWS'] as $rowData)
						{
							...
							?>
								<div id="slide" class="scroll-slide">
									<div class="row pr-4 <?=$rowData['CLASS']?>" data-entity="items-row">
										<?
		...
		<div id="action" class="action">
			<input id="ranger" type="range" min="0" max="1070" value="0" step="1">
		</div>
		<?
		...
		<script src="<?=SITE_TEMPLATE_PATH?>/components/bitrix/catalog.section/bootstrap_v4/slick/slick.js" type="text/javascript" charset="utf-8"></script>
		<script src="<?=SITE_TEMPLATE_PATH?>/components/bitrix/catalog.section/bootstrap_v4/custom-slider.js"></script>
