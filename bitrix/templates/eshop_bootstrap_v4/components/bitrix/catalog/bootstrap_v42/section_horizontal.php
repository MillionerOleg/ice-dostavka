...
if ($isSidebar)
{
	$contentBlockClass = ($isSidebarLeft ? "col-12 order-1 order-sm-2" : "col-12 order-1");
}
else
{
...
?>
<div class="row mb-4 <?=$arParams["TEMPLATE_THEME"]?> col-12">
	<div class="<?=$contentBlockClass?>">
		...
		<div class="row">
			<div class="col">
				...
				$intSectionID = $APPLICATION->IncludeComponent("bitrix:catalog.section", "bootstrap_v42", array(
						"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
						"IBLOCK_ID" => $arParams["IBLOCK_ID"],
