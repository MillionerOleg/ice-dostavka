...
?>
<div class="list-style-buttons d-none d-lg-flex">
			<button class="list-style-button" id="style-grid">
				<div></div>
				<div></div>
				<div></div>
			</button>
			<button class="list-style-button" id="style-list">
				<div></div>
				<div></div>
				<div></div>
			</buttonv>
...
<div class="row mb-4 d-none d-lg-flex">
	<div class="col">
		...
		{
		?><ul class="<? echo $arCurView['LIST']; ?> d-lg-flex d-none">
		<?
