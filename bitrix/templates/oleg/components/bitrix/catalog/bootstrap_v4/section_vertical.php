...
<div class="row mb-4 bx-<?=$arParams["TEMPLATE_THEME"]?>">
	<? if ($isFilter || $isSidebar): ?>
		<div class="col-lg-3 col-12 col-md-4 bx-sidebar-bg <?=(isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' d-none d-sm-block' : '')?>">
			<?
			//region Filter
			if ($isFilter): ?>
				<div class="bx-sidebar-block">
					<div id="serv_title">Услуги</div>
						<div id="product-list">
							<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
								"AREA_FILE_SHOW" => "sect", 
								"AREA_FILE_SUFFIX" => "select", 
	...
	<div class="pb-4 <?=(($isFilter || $isSidebar) ? "col-lg-9 col-md-8 col-12" : "col")?>">
		<?
